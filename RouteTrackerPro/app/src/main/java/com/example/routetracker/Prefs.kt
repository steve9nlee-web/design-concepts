...
object Prefs {
    ...
    fun getExcelUri(ctx: Context): String? = sp(ctx).getString(KEY_EXCEL_URI, null)

    fun setExcelUri(ctx: Context, uri: String?) =
        sp(ctx).edit().putString(KEY_EXCEL_URI, uri).apply()
